...
class Bot:
    ...
    def get_posts(self, comment):
        print('Searching post by tag...')
        bot = self.bot
        link = 'https://www.instagram.com/p/CL4kJnZjMKs/'
        bot.get(link)
